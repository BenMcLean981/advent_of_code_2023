...
pub fn from_str_no_numbers_returns_empty() {
    ...
    let expected = Card::new(1, 1, HashSet::new(), HashSet::new());
...
pub fn from_str_one_number_returns_card() {
    ...
    let expected = Card::new(5, 1, HashSet::from([9]), HashSet::from([512]));
...
pub fn from_str_several_number_returns_card() {
    ...
    let expected =
        Card::new(4, 1, HashSet::from([12, 5, 812]), HashSet::from([68, 1]));
